...
export default function Signup() {
  ...
  const handleOAuthClick = (provider) => {
    const dummyUser = {
      fullName: provider === 'Google' ? 'Alexander Hamilton' : 'Thomas Jefferson',
      email: provider === 'Google' ? 'alexander@news-org.com' : 'thomas@press-agency.org',
      organization: provider === 'Google' ? 'Global Press Collective' : 'Continental Gazette',
    };
