...
export default function Signup() {
  ...
  const handleOAuthClick = async (provider) => {
    if (provider === 'Google') {
      ...
      if (!clientId || clientId === 'placeholder' || clientId.includes('your_google_client_id')) {
        try {
      ...
      // Default to Google Web Client ID
      if (!clientId || clientId === 'placeholder' || clientId.includes('your_google_client_id')) {
        clientId = '20732995217-iufsjspps43gk6b14f80te88bg7dhglp.apps.googleusercontent.com';
      }
  ...
  return (
    <div className="signup-container">
      ...
      <div className="signup-left">
        {/* Logo */}
        <div className="signup-logo-wrapper" style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          ...
          <span style={{ fontSize: '22px', fontWeight: 800, color: 'var(--color-primary)' }}>Veritas AI</span>
        </div>
